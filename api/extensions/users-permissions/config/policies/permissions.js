...
module.exports = async (ctx, next) => {
  ...
  // This is an addition to Strapi default behavior to check for auth token in the cookie,
  // and set the header for the next conditional.
  // The token was added to httpOnly cookie in ../../controllers/auth.js, lines 134-145.
